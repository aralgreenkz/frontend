...
const handleForgotPassword = () => {
  alert('Forgot password functionality will be implemented with API')
}
    ...
    <div class="max-w-md w-full">
      ...
      <div class="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
        ...
        <div class="flex items-center justify-between mb-8 px-2">
          <!-- 标题 - 左侧 -->
          <div class="text-left">
            <h1 class="text-3xl font-bold text-gray-900 mb-1">Log in</h1>
            <p class="text-gray-600">to start learning</p>
          </div>
        ...
        <form @submit.prevent="handleLogin" class="space-y-6">
          ...
          <div>
            ...
            <div class="relative">
              ...
              />
              <div v-if="formData.username === '@michalmalewicz'" class="absolute right-3 top-1/2 transform -translate-y-1/2">
